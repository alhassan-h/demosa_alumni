...
export function LandingPage({ onNavigate }: LandingPageProps) {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-[#0a1f44] via-[#1a3a6b] to-[#0a1f44] text-white overflow-hidden">
          ...
          <div className="max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-5">
              <button
                ...
                className="px-10 py-5 bg-[#2563eb] hover:bg-blue-600 rounded-xl font-bold text-lg flex items-center justify-center transition-all shadow-2xl hover:shadow-blue-500/50 hover:scale-105"
              >
                Join DEMOSA
              ...
              <button
                ...
                className="px-10 py-5 bg-white/10 hover:bg-white/20 backdrop-blur-md border-2 border-white/50 rounded-xl font-bold text-lg transition-all hover:scale-105"
              >
                Member Login
              </button>
            </div>
              ...
              return (
                <div key={index} className="text-center">
                  <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl mb-5 shadow-md">
                    <Icon className="w-10 h-10 text-[#0a1f44]" />
                  </div>
                  <div className="text-4xl md:text-5xl font-bold text-[#0a1f44] mb-3">{stat.value}</div>
            ...
            {features.map((feature, index) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-2xl font-bold text-[#0a1f44] mb-4">{feature.title}</h3>
      ...
      {/* CTA Section */}
      <section className="py-24 bg-gradient-to-r from-[#0a1f44] via-[#1a3a6b] to-[#0a1f44] text-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <button
            onClick={() => onNavigate('register')}
            className="px-12 py-5 bg-[#2563eb] hover:bg-blue-600 rounded-xl font-bold text-lg inline-flex items-center transition-all shadow-2xl hover:shadow-blue-500/50 hover:scale-105"
          >
            Get Started Now
            <ArrowRight className="ml-3 w-6 h-6" />
          </button>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold text-[#0a1f44]">Latest News</h2>
            <button
              onClick={() => onNavigate('news')}
              className="text-[#2563eb] hover:text-blue-700 font-semibold flex items-center px-5 py-3 hover:bg-blue-50 rounded-lg transition-all"
            >
              View All
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[1, 2, 3].map((item) => (
              <div key={item} className="bg-gray-50 rounded-2xl overflow-hidden shadow-md hover:shadow-2xl transition-all hover:-translate-y-2 border border-gray-100">
                ...
                <div className="p-7">
                  <div className="text-sm text-[#2563eb] font-bold mb-3 uppercase tracking-wide">Announcement</div>
                  <h3 className="text-2xl font-bold text-[#0a1f44] mb-4 leading-tight">
                  ...
                  <button
                    onClick={() => onNavigate('news')}
                    className="text-[#2563eb] hover:text-blue-700 font-semibold flex items-center text-sm hover:gap-2 transition-all"
                  >
                    Read More
